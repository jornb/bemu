...
inline int num_rom_banks(const RomSizeType t) {
    switch (t) {
        ...
        default: throw std::runtime_error("Unknown ROM size");
    }
}

inline size_t num_ram_banks(const RamSizeType t) {
    switch (t) {
        case RamSizeType::NoRam: return 0;
        case RamSizeType::Kb8: return 1;
        case RamSizeType::Kb32: return 4;
        case RamSizeType::Kb64: return 8;
        case RamSizeType::Kb128: return 16;
        default: throw std::runtime_error("Unknown RAM size");
    }
}
